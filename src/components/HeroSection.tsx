  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl text-center px-6 md:text-right md:ml-auto md:mr-20">
        <h1 className="text-4xl md:text-6xl font-extrabold text-foreground font-heading leading-tight text-green-700 mb-6">
          Líder em Soluções de TI
        </h1>
        <p className="text-base md:text-lg text-muted-foreground text-green-500 mb-8 max-w-lg md:ml-auto">
